                        ...
                        <div class="flex">
                                ...
                                <ul id="files">
                                    ...
                                    <li v-for="(file, index) in files.items">
                                        <div class="file_link" :data-folder="file.name" :data-index="index">
                                                ...
                                                <template v-if="file.type.includes('image')">
                                                    <div class="img_icon"
                                                         :style="{
                                                             ...
                                                             width: '100%',
                                                             height: '100%',
                                                             backgroundImage: 'url(' + encodeURI(file.path) + ')',
                                            ...
                                            <div class="details" :class="file.type"><h4>@{{ file.name }}</h4>
                                                <small>
                                                    <template v-if="file.type == 'folder'">
                            ...
                            <div id="right">
                                ...
                                <div class="right_details">
                                    <div class="detail_img" :class="selected_file.type">
                                        <template v-if="_.includes(selected_file.type, 'image')">
                                            <img :src="selected_file.path"/>
                                        </template>
                                        <template v-if="_.includes(selected_file.type, 'video')">
                                        ...
                                        <template v-if="_.includes(selected_file.type, 'audio')">
                                        ...
                                        <template v-if="selected_file.type != 'folder' && !_.includes(selected_file.type, 'audio') && !_.includes(selected_file.type, 'video') && !_.includes(selected_file.type, 'image')">
                                            <i class="voyager-file-text-o"></i>
                                        </template>

                                    </div>
                                    <div class="detail_info" :class="selected_file.type">
							<span><h4>Title:</h4>
